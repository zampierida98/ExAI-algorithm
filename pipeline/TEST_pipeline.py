'''
TEST_pipeline rappresenta l'esecuzione del modello completa e si differenzia rispetto a XAI_pipeline 
perché trainset = testset = dataset originale cioè un self test.
- creazione del modello sull'intero dataset
- evaluation sull'intero dataset
'''
...
if __name__ == "__main__":
    ...
    train, test = dataset, dataset      #split_procedure(dataset, test_size=args.test_size)
