...
if __name__ == "__main__":
    ...
    test_adapted = adapt_test_set(dataset, shannon_map, args.class_column_name, args.pos_class_value, args.null_value)
    ...
    pred = evaluation(test_adapted, rules, superior_relation, mark)

    # genero la confusion matrix
    conf_matrix = confusion_matrix(test_adapted, pred)
